...
cat /path/to/tGD/skills/tgd-test-driven-development/SKILL.md > .github/skills/test-driven-development/SKILL.md
cat /path/to/tGD/skills/tgd-code-review-and-quality/SKILL.md > .github/skills/code-review-and-quality/SKILL.md
```
