...
**Not for:** implementation planning (use `tgd-define-spec` or `tgd-plan-breakdown`), bug analysis (use `tgd-verify-debug`), or refining an already-sharp scope.
